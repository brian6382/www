...
if (isset($_POST['saveAndClose'])) {
    ...
    $class_nickname = $_POST['class_nickname'];


   
 
  
    $result = $db->addClass($class_teacher, $class_name, $class_nickname); 
                ...
                <div class="card-body">
                  <form method="POST">
                    ...
                    <div class="form-group">
                          <label for="condition">class teacher</label>
                          <select name="teacher_id" class="form-control">
                              <option disabled value="">--Select Class Teacher--</option>
                              <?php 
                                foreach ($teachers as $teacher) {
                                  ?>
                                    <option value='<?php echo $teacher['teacher_id']; ?>' ><?php echo $teacher['fullname']; ?></option>
                                  <?php
                                }
                              ?>
                          </select>
                    ...
                    <div class="form-group">
                        <label for="inputTitle" class="col-form-label">Class Name  <span class="text-danger">*</span></label>
                        <input id="inputTitle" type="text" name="class_name" placeholder="e.g class 5" required class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="inputTitle" class="col-form-label">Class  Nickname <span class="text-danger">*</span></label>
                        <input id="inputTitle" type="text" name="class_nickname" placeholder="e.g 4 east :" required class="form-control">
                    </div>

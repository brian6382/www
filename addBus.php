...
if (isset($_POST['saveAndClose'])) {
    $driver_id = $_POST['fullname'];
    $route_id = $_POST['email'];
    $registration_number = $_POST['contact'];
    

    $bus_picture = $_FILES['photo']['name'];
    $target_dir = "Bus";
    ...
    $result = $db-> addBus($driver_id, $route_id, $registration_number, $bus_picture); 
            ...
            <div class="card">
                ...
                <div class="card-body">
                  <form method="POST">
                    ...
                    <div class="form-group">
                    <label for="inputPhoto" class="col-form-label">Parent Photo <span class="text-danger">*</span></label>

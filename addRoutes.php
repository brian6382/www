...
if (isset($_POST['saveAndClose'])) {
    ...
    $route_description = $_POST['description'];
    $route_locations = $_POST['locations'];
    

   
 
  
    $result = $db-> addRoutes($route_name, $route_description, $route_locations);
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card">
                <h5 class="card-header">Add Routs</h5>
                <div class="card-body">
                  <form method="POST">
                    <input type="hidden" name="_token" value="v1gPSd2I0cjCGf0FaSRKNZqtUa2wFXZf0LnXnO4I">

                    <div class="form-group">
                        <label for="inputTitle" class="col-form-label">Route Name <span class="text-danger">*</span></label>
                        <input id="inputTitle" type="text" name="route" placeholder="Add Teacher  Name :" required class="form-control">
                    </div>

                     <div class="form-group">
                        <label for="inputTitle" class="col-form-label">Route Description   <span class="text-danger">*</span></label>
                        <input id="inputTitle" type="text" name="description" placeholder="school@gmail.com:" required class="form-control">
                    </div>

                     <div class="form-group">
                        <label for="inputTitle" class="col-form-label">Route Locations  <span class="text-danger">*</span></label>
                        <input id="inputTitle" type="text" name="locations" placeholder="Eg 0723435" required class="form-control">
                    </div>
<!-- 
                     <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="inputTitle" type="text" name="position" placeholder=" e.g Head Teacher :" required class="form-control">
                    </div>

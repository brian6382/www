...
if (isset($_POST['saveAndClose'])) {
    ...
    $profile_photo = $_FILES['photo']['name'];
    $target_dir = "profile";
    ...
    $finalImagePath = "profile".$imagePath;
    ...
    $result = $db->addParents($fullname, $email, $contact, $address, $profile_photo, $password); 
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card">
                <h5 class="card-header">Add Parent</h5>
                <div class="card-body">
